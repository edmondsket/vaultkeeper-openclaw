...
export enum EnglishCopy {
    ...
    SettingCustomSkillsDesc = "Define your own quick-action skills with custom prompts and model selection.",
    SettingCustomSkillName = "Skill name",
    SettingCustomSkillNameDesc = "Display name shown in menus and command palette.",
    SettingCustomSkillIcon = "Icon",
    SettingCustomSkillIconDesc = "Obsidian icon name (e.g. scan-text, palette, link).",
    SettingCustomSkillPrompt = "System prompt",
    SettingCustomSkillPromptDesc = "Instructions sent to the AI for this skill.",
    SettingCustomSkillModel = "Model",
    SettingCustomSkillModelDesc = "Model to use for this skill. Uses the default quick-action model if not set.",
    SettingCustomSkillApplyTo = "Apply to",
    SettingCustomSkillApplyToDesc = "Whether the skill acts on selected text or the whole note.",
    SettingCustomSkillOutputMode = "Output mode",
    SettingCustomSkillOutputModeDesc = "How the result is applied: replace the input, append after it, or show as a notice.",
    CustomSkillApplyToSelection = "Selection",
    CustomSkillApplyToWholeNote = "Whole note",
    CustomSkillOutputReplace = "Replace",
    CustomSkillOutputAppend = "Append",
    CustomSkillOutputNotice = "Show notice",
    CustomSkillRunning = "Running {0}...",
    ButtonAddCustomSkill = "Add skill",
    ButtonEditCustomSkill = "Edit",
    ButtonDeleteCustomSkill = "Delete",
    CommandQuickActionPrefix = "Vaultkeeper: ",
    SettingS3 = "S3 Storage",
    SettingS3Desc = "Upload non-image files to your own S3-compatible storage and send direct URLs to the model.",
    SettingS3Enabled = "Enable S3 storage",
    SettingS3EnabledDesc = "When enabled, non-image file attachments are uploaded to S3 instead of being sent inline or to the AI provider's file API.",
    SettingS3Endpoint = "Endpoint",
    SettingS3EndpointDesc = "S3-compatible endpoint URL (e.g. https://s3.amazonaws.com).",
    SettingS3Region = "Region",
    SettingS3RegionDesc = "AWS region (e.g. us-east-1).",
    SettingS3AccessKeyId = "Access key ID",
    SettingS3SecretAccessKey = "Secret access key",
    SettingS3Bucket = "Bucket",
    SettingS3BucketDesc = "Target S3 bucket name.",
    SettingS3PublicBaseUrl = "Public base URL",
    SettingS3PublicBaseUrlDesc = "Base URL for generating direct download links. Leave empty to use endpoint/bucket.",
    SettingS3PathPrefix = "Path prefix",
    SettingS3PathPrefixDesc = "Optional prefix folder within the bucket (e.g. vaultkeeper-attachments/).",
